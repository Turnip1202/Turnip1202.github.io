(()=>{"use strict";var e={774:function(e,r,n){var t=n(773),o=n(699),i=n(511),a=n(880);let d=[{id:0,name:"Turnip",links:[{id:1,name:"Turnip's Blog",url:"https://turnip1202.github.io/my-blog-astro/",icon:"\uD83E\uDD55"},{id:2,name:"GitHub",url:"https://github.com/Turnip1202",icon:"⭐"},{id:3,name:"稀土掘金",url:"https://juejin.cn/user/1684912023022440",icon:"\uD83D\uDD28"},{id:4,name:"哔哩哔哩",url:"https://b23.tv/zpySzz9",icon:"\uD83C\uDFAE"},{id:5,name:"抖音",url:"https://v.douyin.com/if78aSq9/",icon:"\uD83C\uDFAC"}]},{id:1,name:"开发工具",links:[{id:1,name:"GitHub",url:"https://github.com",icon:"\uD83D\uDC19"},{id:2,name:"VS Code",url:"https://code.visualstudio.com",icon:"\uD83D\uDCDD"},{id:3,name:"Stack Overflow",url:"https://stackoverflow.com",icon:"\uD83D\uDCA1"}]},{id:2,name:"学习资源",links:[{id:4,name:"TypeScript",url:"https://www.typescriptlang.org",icon:"\uD83D\uDCD8"},{id:5,name:"React Docs",url:"https://reactjs.org",icon:"⚛️"},{id:6,name:"掘金",url:"https://juejin.cn",icon:"\uD83C\uDFAF"}]}],c=[{id:"google",name:"Google",url:"https://www.google.com/search?q=",icon:"\uD83D\uDD0D"},{id:"bing",name:"Bing",url:"https://www.bing.com/search?q=",icon:"\uD83D\uDD0E"},{id:"baidu",name:"百度",url:"https://www.baidu.com/s?wd=",icon:"\uD83D\uDD0D"}],l=a.Z.div`
  margin: 2rem auto;
  max-width: 600px;
  width: 100%;
`,u=a.Z.form`
...
`,f=()=>{let[e,r]=(0,o.useState)(""),[n,i]=(0,o.useState)(c["0"].id);return(0,t.jsx)(l,{children:(0,t.jsxs)(u,{onSubmit:r=>{if(r.preventDefault(),!e.trim())return;let t=c.find(e=>e.id===n);t&&window.open(t.url+encodeURIComponent(e),"_blank")},children:[(0,t.jsx)(s,{type:"text",value:e,onChange:e=>r(e.target.value),placeholder:"输入搜索内容..."}),(0,t.jsx)(p,{value:n,onChange:e=>i(e.target.value),children:c.map(e=>(0,t.jsxs)("option",{value:e.id,children:[e.icon," ",e.name]},e.id))}),(0,t.jsx)(m,{type:"submit",children:"搜索"})]})})},h=a.Z.section`
  margin: 2rem 0;
  padding: 1rem;
  background: white;
  border-radius: 12px;
