...
`,p=d.Z.button`
  ...
  &:hover {
    color: ${e=>"custom"===e.theme.id&&"暗黑主题"===e.theme.name?"#ff6666":"#ff0000"};
  }
...
`,f=e=>{let{searchEngines:t}=e,[i,r]=(0,n.useState)(""),[o,s]=(0,n.useState)(t[0].id);return(0,a.jsx)(l,{children:(0,a.jsxs)(c,{onSubmit:e=>{if(e.preventDefault(),!i.trim())return;let r=t.find(e=>e.id===o);r&&window.open(r.url+encodeURIComponent(i),"_blank")},children:[(0,a.jsxs)(m,{children:[(0,a.jsx)(u,{type:"text",value:i,onChange:e=>r(e.target.value),placeholder:"输入搜索内容..."}),i&&(0,a.jsx)(p,{type:"button",onClick:()=>r(""),"aria-label":"清空输入",children:"\xd7"})]}),(0,a.jsx)(h,{value:o,onChange:e=>s(e.target.value),children:t.map(e=>(0,a.jsxs)("option",{value:e.id,children:[e.icon," ",e.name]},e.id))}),(0,a.jsx)(g,{type:"submit",children:"搜索"})]})})},x=d.Z.section`
  margin: 2rem 0;
  padding: 1rem;
...
`,w=e=>{let{categories:t}=e;return(0,a.jsx)(a.Fragment,{children:t.map(e=>(0,a.jsxs)(x,{children:[(0,a.jsx)(b,{children:e.name}),(0,a.jsx)(S,{children:e.links.map(e=>(0,a.jsxs)(y,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:[(0,a.jsx)(E,{children:e.icon}),(0,a.jsx)(v,{children:e.name})]},e.id))})]},e.id))})},k=d.Z.div`
  min-height: 100vh;
  position: relative;
  padding: 2rem;
...
`,L=(0,d.Z)(D)`
  ...
  align-items: center;
  justify-content: center;
`,M=e=>{let{themeConfig:t,onSelect:i}=e;t=_.getConfig();let[r,o]=(0,n.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-mode");return!!e&&"dark"===e}catch(e){return console.warn("Failed to load theme mode:",e),!1}}),[s,d]=(0,n.useState)(()=>{try{return localStorage.getItem("turnip-theme-preset")||"morning"}catch(e){return console.warn("Failed to load theme preset:",e),"morning"}}),[l,c]=(0,n.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-auto");return!!e&&"true"===e}catch(e){return console.warn("Failed to load auto mode:",e),!1}});(0,n.useEffect)(()=>{try{localStorage.setItem("turnip-theme-mode",r?"dark":"light"),localStorage.setItem("turnip-theme-auto",String(l)),localStorage.setItem("turnip-theme-preset",s)}catch(e){console.warn("Failed to save theme settings:",e)}},[r,l,s]),(0,n.useEffect)(()=>{let e=()=>{if(!l)return;let e=new Date().getHours(),t=e>=18||e<6;t!==r&&o(t)};e();let t=setInterval(e,6e4);return()=>clearInterval(t)},[l,r]);let m=(0,n.useCallback)(()=>{let e=t.presets.find(e=>e.id===s)||t.presets[0];i({id:"custom",name:r?"暗黑主题":"明亮主题",backgroundImage:r?"linear-gradient(120deg, #2d3436 0%, #2d3436 100%)":e.backgroundImage,blur:e.blur,opacity:r?.85:e.opacity})},[r,s,i]);return(0,n.useEffect)(()=>{m()},[r,m]),(0,a.jsxs)(C,{children:[!r&&(0,a.jsx)(O,{children:t.presets.map(e=>(0,a.jsx)(P,{isSelected:s===e.id,onClick:()=>d(e.id),title:e.name,style:{background:e.backgroundImage}},e.id))}),(0,a.jsxs)($,{children:[(0,a.jsx)(D,{active:r,onClick:()=>{c(!1),o(!r)},title:r?"切换到明亮模式":"切换到暗黑模式",children:r?(0,a.jsx)("span",{children:"\uD83C\uDF19"}):(0,a.jsx)("span",{children:"☀️"})}),(0,a.jsx)(L,{active:l,onClick:()=>c(!l),title:l?"关闭自动切换":"开启自动切换",children:"\uD83D\uDD52"})]})]})},K=d.Z.div`
  position: absolute;
  top: 0.1rem;
  right: 1rem;
  font-size: 1.2rem;
...
`,Y=()=>{let[e,t]=(0,n.useState)(new Date);return(0,n.useEffect)(()=>{let e=setInterval(()=>{t(new Date)},1e3);return()=>clearInterval(e)},[]),(0,a.jsx)(K,{children:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}:${String(e.getSeconds()).padStart(2,"0")}`})};var F=((r={})[r.THEME_ADMIN_PANEL=0]="THEME_ADMIN_PANEL",r[r.SITE_ADMIN_PANEL=1]="SITE_ADMIN_PANEL",r[r.LINKS_ADMIN_PANEL=2]="LINKS_ADMIN_PANEL",r),G=i(9076),z=i(3195),R=i(9576),B=i(9247),q=i(9271),H=i(3363),J=i(3716),V=i(9586),U=i(5395),Q=i(1582),W=i(4573),X=i(7275),ee=i(8589);let et=()=>{let[e,t]=(0,n.useState)([]),[i,r]=(0,n.useState)(!1),[o,s]=(0,n.useState)(!1),[d]=G.Z.useForm(),[l]=G.Z.useForm(),[c,m]=(0,n.useState)(),[h,g]=(0,n.useState)(null),[u,p]=(0,n.useState)(null);(0,n.useEffect)(()=>{t(T.getAllCategories())},[]);let f=e=>{console.log("Editing category: ",e),m(e),d.setFieldsValue(e),r(!0)},x=i=>{t(e.filter(e=>e.id!==i)),T.deleteCategory(i),z.ZP.success("Category deleted successfully!")},b=()=>{s(!0),l.resetFields(),g(null)},S=[{title:"ID",dataIndex:"id",key:"id",sorter:(e,t)=>e.id-t.id},{title:"Name",dataIndex:"name",key:"name"},{title:"Links",dataIndex:"links",key:"links",render:e=>(0,a.jsx)(R.Z,{size:"middle",children:(0,a.jsx)("div",{style:{height:100,overflow:"auto"},children:(0,a.jsx)(B.Z,{bordered:!0,dataSource:e,renderItem:e=>(0,a.jsxs)(B.Z.Item,{children:[e.icon,": ",e.name?`${e.name}-> `:"",e.url]})})})})},{title:"Action",key:"action",render:(e,t)=>(0,a.jsxs)(R.Z,{size:"middle",children:[(0,a.jsx)(q.ZP,{type:"primary",icon:(0,a.jsx)(Q.Z,{}),onClick:()=>f(t),children:"Edit Category"}),(0,a.jsx)(q.ZP,{type:"dashed",icon:(0,a.jsx)(W.Z,{}),onClick:()=>x(t.id),children:"Delete Category"})]})}];return(0,a.jsxs)("div",{style:{padding:24},children:[(0,a.jsx)("h1",{children:"Data Management Panel"}),(0,a.jsx)(q.ZP,{type:"primary",icon:(0,a.jsx)(X.Z,{}),onClick:()=>{d.resetFields(),m(void 0),r(!0)},style:{marginBottom:16},children:"Add New Category"}),(0,a.jsx)(q.ZP,{type:"primary",icon:(0,a.jsx)(ee.Z,{}),onClick:()=>b(),children:"Add Links"}),(0,a.jsx)(q.ZP,{type:"dashed",icon:(0,a.jsx)(X.Z,{}),onClick:()=>{T.clearStorage(),t([]),z.ZP.success("All categories deleted successfully")},style:{marginBottom:16},children:"清空数据"}),(0,a.jsx)(H.Z,{dataSource:e,columns:S,rowKey:"id",pagination:{pageSize:5}}),(0,a.jsx)(J.Z,{title:`${c?"Edit":"Add"} Category`,open:i,onOk:()=>{d.validateFields().then(i=>{console.log(i),c?(t(e.map(e=>e.id===c.id?{...e,...i}:e)),T.updateCategory(i.id,i.name),z.ZP.success("Category updated successfully!")):(t([...e,{id:Date.now(),...i,links:[]}]),T.addCategory(i.name),z.ZP.success("Category added successfully!")),r(!1)})},onCancel:()=>{r(!1)},children:(0,a.jsxs)(G.Z,{form:d,layout:"vertical",children:[(0,a.jsx)(G.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(V.Z,{disabled:!!c})}),(0,a.jsx)(G.Z.Item,{name:"name",label:"Name",rules:[{required:!0,message:"Please input Name!"}],children:(0,a.jsx)(V.Z,{})})]})}),(0,a.jsx)(J.Z,{title:`${h??"Add"} Link`,open:o,onOk:()=>{l.validateFields().then(i=>{let r=e.findIndex(e=>e.id===u),a=[...e];if(h){console.log("updating link");let e=i.id,t={icon:i.icon,name:i.name,url:i.url};T.updateLink(r,e,t),z.ZP.success("Link updated successfully!")}else console.log("adding link"),T.addLink(i.id,i.name,i.url,i.icon),z.ZP.success("Link added successfully!");t(a),s(!1)})},onCancel:()=>{s(!1)},children:(0,a.jsxs)(G.Z,{form:l,layout:"vertical",children:[(0,a.jsx)(G.Z.Item,{name:"id",label:"分类",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(U.Z,{disabled:!!h,options:e.map(e=>({value:e.id,label:e.name}))})}),(0,a.jsx)(G.Z.Item,{name:"name",label:"链接名",rules:[{required:!1,message:"Please input Name!"}],children:(0,a.jsx)(V.Z,{})}),(0,a.jsx)(G.Z.Item,{name:"url",label:"链接",rules:[{required:!0,message:"Please input URL!"}],children:(0,a.jsx)(V.Z,{})}),(0,a.jsx)(G.Z.Item,{name:"icon",label:"图标",rules:[{required:!0,message:"Please input Icon!"}],children:(0,a.jsx)(V.Z,{})})]})})]})},ei=e=>{switch(e.config){case F.THEME_ADMIN_PANEL:return(0,a.jsx)("div",{children:"主题管理面板(未完成)"});case F.SITE_ADMIN_PANEL:return(0,a.jsx)("div",{children:"网站管理面板(未完成)"});case F.LINKS_ADMIN_PANEL:return(0,a.jsx)(et,{});default:return(0,a.jsx)("div",{children:"未知面板"})}},er=[{name:"链接配置面板",type:"link",value:F.LINKS_ADMIN_PANEL},{name:"主题配置面板",type:"link",value:F.THEME_ADMIN_PANEL},{name:"网站配置面板",type:"link",value:F.SITE_ADMIN_PANEL}],ea=e=>{let{visibleAdmin:t,setIsShowAdmin:i,setVisibleAdmin:r,setToConfig:n,isShowAdmin:o}=e,s=e=>()=>{switch(console.log("toAdmin",e),e.value){case F.LINKS_ADMIN_PANEL:n(F.LINKS_ADMIN_PANEL);break;case F.THEME_ADMIN_PANEL:n(F.THEME_ADMIN_PANEL);break;case F.SITE_ADMIN_PANEL:n(F.SITE_ADMIN_PANEL);break;default:r(!0)}r(!0),i(!1)};return(0,a.jsx)(a.Fragment,{children:(0,a.jsx)(J.Z,{title:"请选择进入哪一个面板",footer:[(0,a.jsx)(q.ZP,{style:{display:t?"":"none"},onClick:()=>{i(!1),r(!1)},children:"退出面板"},"back")],open:o,onCancel:()=>i(!1),children:er.map((e,t)=>(0,a.jsx)(q.ZP,{onClick:s(e),type:e.type,children:e.name},t))})})},en=d.Z.button`
  opacity: 0.5; /* 默认透明度 */
