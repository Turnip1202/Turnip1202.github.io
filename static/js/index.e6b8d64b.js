(()=>{"use strict";var e={5946:function(e,t,r){var i=r(6773),o=r(1699),a=r(8511),n=r(2598),s=r(9333);let d=s.Z.div`
  margin: 2rem auto;
  max-width: 600px;
  width: 100%;
  padding: 0 15px;
...
`,v=e=>{let{categories:t}=e;return(0,i.jsx)(i.Fragment,{children:t.map(e=>(0,i.jsxs)(u,{children:[(0,i.jsx)(p,{children:e.name}),(0,i.jsx)(f,{children:e.links.map(e=>(0,i.jsxs)(x,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:[(0,i.jsx)(b,{children:e.icon}),(0,i.jsx)(S,{children:e.name})]},e.id))})]},e.id))})},w=s.Z.div`
  min-height: 100vh;
  position: relative;
  padding: 2rem;
...
`,G=(0,s.Z)(Y)`
  ...
  align-items: center;
  justify-content: center;
`,K=e=>{let{themeConfig:t,onSelect:r}=e;t=k.getConfig();let[a,n]=(0,o.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-mode");return!!e&&"dark"===e}catch(e){return console.warn("Failed to load theme mode:",e),!1}}),[s,d]=(0,o.useState)(()=>{try{return localStorage.getItem("turnip-theme-preset")||"morning"}catch(e){return console.warn("Failed to load theme preset:",e),"morning"}}),[l,c]=(0,o.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-auto");return!!e&&"true"===e}catch(e){return console.warn("Failed to load auto mode:",e),!1}});(0,o.useEffect)(()=>{try{localStorage.setItem("turnip-theme-mode",a?"dark":"light"),localStorage.setItem("turnip-theme-auto",String(l)),localStorage.setItem("turnip-theme-preset",s)}catch(e){console.warn("Failed to save theme settings:",e)}},[a,l,s]),(0,o.useEffect)(()=>{let e=()=>{if(!l)return;let e=new Date().getHours(),t=e>=18||e<6;t!==a&&n(t)};e();let t=setInterval(e,6e4);return()=>clearInterval(t)},[l,a]);let g=(0,o.useCallback)(()=>{let e=t.presets.find(e=>e.id===s)||t.presets[0];r({id:"custom",name:a?"暗黑主题":"明亮主题",backgroundImage:a?"linear-gradient(120deg, #2d3436 0%, #2d3436 100%)":e.backgroundImage,blur:e.blur,opacity:a?.85:e.opacity})},[a,s,r]);return(0,o.useEffect)(()=>{g()},[a,g]),(0,i.jsxs)(_,{children:[!a&&(0,i.jsx)($,{children:t.presets.map(e=>(0,i.jsx)(C,{isSelected:s===e.id,onClick:()=>d(e.id),title:e.name,style:{background:e.backgroundImage}},e.id))}),(0,i.jsxs)(O,{children:[(0,i.jsx)(Y,{active:a,onClick:()=>{c(!1),n(!a)},title:a?"切换到明亮模式":"切换到暗黑模式",children:a?(0,i.jsx)("span",{children:"\uD83C\uDF19"}):(0,i.jsx)("span",{children:"☀️"})}),(0,i.jsx)(G,{active:l,onClick:()=>c(!l),title:l?"关闭自动切换":"开启自动切换",children:"\uD83D\uDD52"})]})]})},Z=s.Z.div`
  position: absolute;
  top: 0.1rem;
  right: 1rem;
  font-size: 1.2rem;
...
`,D=e=>{let{cb:t}=e,r=k.getConfig(),o=I.getAllCategories(),a=I.getAllSearchEngines(),n=j.getConfig();return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)(A,{}),(0,i.jsx)(N,{children:(0,i.jsx)(z,{children:n.title})}),(0,i.jsxs)(R,{children:[(0,i.jsx)(m,{searchEngines:a}),(0,i.jsx)(v,{categories:o})]}),(0,i.jsx)(K,{themeConfig:r,onSelect:t}),(0,i.jsx)(F,{children:`${n.copyright.text}`})]})},B="turnip-theme-active",P=e=>{let[t,r]=(0,o.useState)(()=>{try{let t=localStorage.getItem(B);return t?JSON.parse(t):e.default}catch(t){return console.warn("Failed to parse saved theme:",t),e.default}});return(0,o.useEffect)(()=>{try{localStorage.setItem(B,JSON.stringify(t))}catch(e){console.warn("Failed to save theme:",e)}},[t]),[t,r]};var M=r(6331),J=r(4095),q=r(5267);r(9888);let H=document.getElementById("root");H&&a.createRoot(H).render((0,i.jsx)(o.StrictMode,{children:(0,i.jsx)(()=>{let[e,t]=P(k.getConfig());return(0,i.jsx)(n.a,{theme:e,children:(0,i.jsxs)(w,{theme:e,children:[(0,i.jsx)(M.ZP,{theme:{algorithm:J.Z.darkAlgorithm},children:(0,i.jsx)(q.ZP,{onClick:()=>{console.log("showAdmin")},children:"管理面板"})}),(0,i.jsx)(D,{cb:t})]})})},{})}))}},t={};function r(i){var o=t[i];if(void 0!==o)return o.exports;var a=t[i]={exports:{}};return e[i](a,a.exports,r),a.exports}r.m=e,r.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return r.d(t,{a:t}),t},(()=>{var e,t=Object.getPrototypeOf?e=>Object.getPrototypeOf(e):e=>e.__proto__;r.t=function(i,o){if(1&o&&(i=this(i)),8&o||"object"==typeof i&&i&&(4&o&&i.__esModule||16&o&&"function"==typeof i.then))return i;var a=Object.create(null);r.r(a);var n={};e=e||[null,t({}),t([]),t(t)];for(var s=2&o&&i;"object"==typeof s&&!~e.indexOf(s);s=t(s))Object.getOwnPropertyNames(s).forEach(e=>{n[e]=()=>i[e]});return n.default=()=>i,r.d(a,n),a}})(),r.d=(e,t)=>{for(var i in t)r.o(t,i)&&!r.o(e,i)&&Object.defineProperty(e,i,{enumerable:!0,get:t[i]})},r.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),r.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},(()=>{var e=[];r.O=function(t,i,o,a){if(i){a=a||0;for(var n=e.length;n>0&&e[n-1][2]>a;n--)e[n]=e[n-1];e[n]=[i,o,a];return}for(var s=1/0,n=0;n<e.length;n++){for(var i=e[n][0],o=e[n][1],a=e[n][2],d=!0,l=0;l<i.length;l++)(!1&a||s>=a)&&Object.keys(r.O).every(function(e){return r.O[e](i[l])})?i.splice(l--,1):(d=!1,a<s&&(s=a));if(d){e.splice(n--,1);var c=o();void 0!==c&&(t=c)}}return t}})(),r.rv=()=>"1.2.7",(()=>{var e={980:0};r.O.j=t=>0===e[t];var t=(t,i)=>{var o,a,[n,s,d]=i,l=0;if(n.some(t=>0!==e[t])){for(o in s)r.o(s,o)&&(r.m[o]=s[o]);if(d)var c=d(r)}for(t&&t(i);l<n.length;l++)a=n[l],r.o(e,a)&&e[a]&&e[a][0](),e[a]=0;return r.O(c)},i=self.webpackChunkrs_react_app=self.webpackChunkrs_react_app||[];i.forEach(t.bind(null,0)),i.push=t.bind(null,i.push.bind(i))})(),r.ruid="bundler=rspack@1.2.7";var i=r.O(void 0,["361","863"],function(){return r(5946)});i=r.O(i)})();