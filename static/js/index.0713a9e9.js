(()=>{"use strict";var e={7593:function(e,t,i){var r,a=i(4132),n=i(9546),o=i(828),s=i(8336),d=i(6010);let l=d.Z.div`
  margin: 2rem auto;
  max-width: 600px;
  width: 100%;
  padding: 0 15px;
...
`,M=()=>{let[e,t]=(0,n.useState)(new Date);return(0,n.useEffect)(()=>{let e=setInterval(()=>{t(new Date)},1e3);return()=>clearInterval(e)},[]),(0,a.jsx)(L,{children:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}:${String(e.getSeconds()).padStart(2,"0")}`})};var K=((r={})[r.THEME_ADMIN_PANEL=0]="THEME_ADMIN_PANEL",r[r.SITE_ADMIN_PANEL=1]="SITE_ADMIN_PANEL",r[r.LINKS_ADMIN_PANEL=2]="LINKS_ADMIN_PANEL",r),Y=i(7429),F=i(7775),G=i(5906),z=i(7606),R=i(8976),B=i(1327),q=i(8400),H=i(5685),J=i(8284),V=i(557),U=i(6786),Q=i(4766),W=i(2566);let X=()=>{let[e,t]=(0,n.useState)([]),[i,r]=(0,n.useState)(!1),[o,s]=(0,n.useState)(!1),[d]=Y.Z.useForm(),[l]=Y.Z.useForm(),[c,m]=(0,n.useState)(),[g,h]=(0,n.useState)(null),[u,p]=(0,n.useState)(null);(0,n.useEffect)(()=>{t(j.getAllCategories())},[]);let f=e=>{console.log("Editing category: ",e),m(e),d.setFieldsValue(e),r(!0)},x=i=>{t(e.filter(e=>e.id!==i)),j.deleteCategory(i),F.ZP.success("Category deleted successfully!")},b=()=>{s(!0),l.resetFields(),h(null)},S=[{title:"ID",dataIndex:"id",key:"id",sorter:(e,t)=>e.id-t.id},{title:"Name",dataIndex:"name",key:"name"},{title:"Links",dataIndex:"links",key:"links",render:e=>(0,a.jsxs)(G.Z,{size:"middle",children:[(0,a.jsx)("div",{style:{height:100,overflow:"auto"},children:(0,a.jsx)(z.Z,{bordered:!0,dataSource:e,renderItem:e=>(0,a.jsxs)(z.Z.Item,{children:[e.icon,": ",e.name?`${e.name}-> `:"",e.url]})})}),e.map(e=>`${e.icon}: ${e.name?`${e.name}-> `:""}${e.url}`).join(", ")]})},{title:"Action",key:"action",render:(e,t)=>(0,a.jsxs)(G.Z,{size:"middle",children:[(0,a.jsx)(R.ZP,{type:"primary",icon:(0,a.jsx)(V.Z,{}),onClick:()=>f(t),children:"Edit Category"}),(0,a.jsx)(R.ZP,{type:"dashed",icon:(0,a.jsx)(U.Z,{}),onClick:()=>x(t.id),children:"Delete Category"})]})}];return(0,a.jsxs)("div",{style:{padding:24},children:[(0,a.jsx)("h1",{children:"Data Management Panel"}),(0,a.jsx)(R.ZP,{type:"primary",icon:(0,a.jsx)(Q.Z,{}),onClick:()=>{d.resetFields(),m(void 0),r(!0)},style:{marginBottom:16},children:"Add New Category"}),(0,a.jsx)(R.ZP,{type:"primary",icon:(0,a.jsx)(W.Z,{}),onClick:()=>b(),children:"Add Links"}),(0,a.jsx)(R.ZP,{type:"dashed",icon:(0,a.jsx)(Q.Z,{}),onClick:()=>{j.clearStorage(),t([]),F.ZP.success("All categories deleted successfully")},style:{marginBottom:16},children:"清空数据"}),(0,a.jsx)(B.Z,{dataSource:e,columns:S,rowKey:"id",pagination:{pageSize:5}}),(0,a.jsx)(q.Z,{title:`${c?"Edit":"Add"} Category`,open:i,onOk:()=>{d.validateFields().then(i=>{console.log(i),c?(t(e.map(e=>e.id===c.id?{...e,...i}:e)),j.updateCategory(i.id,i.name),F.ZP.success("Category updated successfully!")):(t([...e,{id:Date.now(),...i,links:[]}]),j.addCategory(i.name),F.ZP.success("Category added successfully!")),r(!1)})},onCancel:()=>{r(!1)},children:(0,a.jsxs)(Y.Z,{form:d,layout:"vertical",children:[(0,a.jsx)(Y.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(H.Z,{disabled:!!c})}),(0,a.jsx)(Y.Z.Item,{name:"name",label:"Name",rules:[{required:!0,message:"Please input Name!"}],children:(0,a.jsx)(H.Z,{})})]})}),(0,a.jsx)(q.Z,{title:`${g??"Add"} Link`,open:o,onOk:()=>{l.validateFields().then(i=>{let r=e.findIndex(e=>e.id===u),a=[...e];if(g){console.log("updating link");let e=i.id,t={icon:i.icon,name:i.name,url:i.url};j.updateLink(r,e,t),F.ZP.success("Link updated successfully!")}else console.log("adding link"),j.addLink(i.id,i.name,i.url,i.icon),F.ZP.success("Link added successfully!");t(a),s(!1)})},onCancel:()=>{s(!1)},children:(0,a.jsxs)(Y.Z,{form:l,layout:"vertical",children:[(0,a.jsx)(Y.Z.Item,{name:"id",label:"分类",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(J.Z,{disabled:!!g,options:e.map(e=>({value:e.id,label:e.name}))})}),(0,a.jsx)(Y.Z.Item,{name:"name",label:"链接名",rules:[{required:!1,message:"Please input Name!"}],children:(0,a.jsx)(H.Z,{})}),(0,a.jsx)(Y.Z.Item,{name:"url",label:"链接",rules:[{required:!0,message:"Please input URL!"}],children:(0,a.jsx)(H.Z,{})}),(0,a.jsx)(Y.Z.Item,{name:"icon",label:"图标",rules:[{required:!0,message:"Please input Icon!"}],children:(0,a.jsx)(H.Z,{})})]})})]})},ee=e=>{switch(e.config){case K.THEME_ADMIN_PANEL:return(0,a.jsx)("div",{children:"主题管理面板(未完成)"});case K.SITE_ADMIN_PANEL:return(0,a.jsx)("div",{children:"网站管理面板(未完成)"});case K.LINKS_ADMIN_PANEL:return(0,a.jsx)(X,{});default:return(0,a.jsx)("div",{children:"未知面板"})}},et=[{name:"链接配置面板",type:"link",value:K.LINKS_ADMIN_PANEL},{name:"主题配置面板",type:"link",value:K.THEME_ADMIN_PANEL},{name:"网站配置面板",type:"link",value:K.SITE_ADMIN_PANEL}],ei=e=>{let{visibleAdmin:t,setIsShowAdmin:i,setVisibleAdmin:r,setToConfig:n,isShowAdmin:o}=e,s=e=>()=>{switch(console.log("toAdmin",e),e.value){case K.LINKS_ADMIN_PANEL:n(K.LINKS_ADMIN_PANEL);break;case K.THEME_ADMIN_PANEL:n(K.THEME_ADMIN_PANEL);break;case K.SITE_ADMIN_PANEL:n(K.SITE_ADMIN_PANEL);break;default:r(!0)}r(!0),i(!1)};return(0,a.jsx)(a.Fragment,{children:(0,a.jsx)(q.Z,{title:"请选择进入哪一个面板",footer:[(0,a.jsx)(R.ZP,{style:{display:t?"":"none"},onClick:()=>{i(!1),r(!1)},children:"退出面板"},"back")],open:o,onCancel:()=>i(!1),children:et.map((e,t)=>(0,a.jsx)(R.ZP,{onClick:s(e),type:e.type,children:e.name},t))})})},er=d.Z.button`
  opacity: 0.5; /* 默认透明度 */
