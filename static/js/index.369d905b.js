(()=>{"use strict";var e={4745:function(e,t,i){var r,a=i(4132),n=i(9546),o=i(828),s=i(8336),d=i(6010);let l=d.Z.div`
  margin: 2rem auto;
  max-width: 600px;
  width: 100%;
  padding: 0 15px;
...
`,u=e=>{let{searchEngines:t}=e,[i,r]=(0,n.useState)(""),[o,s]=(0,n.useState)(t[0].id);return(0,a.jsx)(l,{children:(0,a.jsxs)(c,{onSubmit:e=>{if(e.preventDefault(),!i.trim())return;let r=t.find(e=>e.id===o);r&&window.open(r.url+encodeURIComponent(i),"_blank")},children:[(0,a.jsx)(m,{type:"text",value:i,onChange:e=>r(e.target.value),placeholder:"输入搜索内容..."}),(0,a.jsx)(g,{value:o,onChange:e=>s(e.target.value),children:t.map(e=>(0,a.jsxs)("option",{value:e.id,children:[e.icon," ",e.name]},e.id))}),(0,a.jsx)(h,{type:"submit",children:"搜索"})]})})},p=d.Z.section`
  margin: 2rem 0;
  padding: 1rem;
...
`,O=(0,d.Z)($)`
  ...
  align-items: center;
  justify-content: center;
`,P=e=>{let{themeConfig:t,onSelect:i}=e;t=w.getConfig();let[r,o]=(0,n.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-mode");return!!e&&"dark"===e}catch(e){return console.warn("Failed to load theme mode:",e),!1}}),[s,d]=(0,n.useState)(()=>{try{return localStorage.getItem("turnip-theme-preset")||"morning"}catch(e){return console.warn("Failed to load theme preset:",e),"morning"}}),[l,c]=(0,n.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-auto");return!!e&&"true"===e}catch(e){return console.warn("Failed to load auto mode:",e),!1}});(0,n.useEffect)(()=>{try{localStorage.setItem("turnip-theme-mode",r?"dark":"light"),localStorage.setItem("turnip-theme-auto",String(l)),localStorage.setItem("turnip-theme-preset",s)}catch(e){console.warn("Failed to save theme settings:",e)}},[r,l,s]),(0,n.useEffect)(()=>{let e=()=>{if(!l)return;let e=new Date().getHours(),t=e>=18||e<6;t!==r&&o(t)};e();let t=setInterval(e,6e4);return()=>clearInterval(t)},[l,r]);let m=(0,n.useCallback)(()=>{let e=t.presets.find(e=>e.id===s)||t.presets[0];i({id:"custom",name:r?"暗黑主题":"明亮主题",backgroundImage:r?"linear-gradient(120deg, #2d3436 0%, #2d3436 100%)":e.backgroundImage,blur:e.blur,opacity:r?.85:e.opacity})},[r,s,i]);return(0,n.useEffect)(()=>{m()},[r,m]),(0,a.jsxs)(N,{children:[!r&&(0,a.jsx)(C,{children:t.presets.map(e=>(0,a.jsx)(Z,{isSelected:s===e.id,onClick:()=>d(e.id),title:e.name,style:{background:e.backgroundImage}},e.id))}),(0,a.jsxs)(A,{children:[(0,a.jsx)($,{active:r,onClick:()=>{c(!1),o(!r)},title:r?"切换到明亮模式":"切换到暗黑模式",children:r?(0,a.jsx)("span",{children:"\uD83C\uDF19"}):(0,a.jsx)("span",{children:"☀️"})}),(0,a.jsx)(O,{active:l,onClick:()=>c(!l),title:l?"关闭自动切换":"开启自动切换",children:"\uD83D\uDD52"})]})]})},D=d.Z.div`
  position: absolute;
  top: 0.1rem;
  right: 1rem;
  font-size: 1.2rem;
...
`,L=()=>{let[e,t]=(0,n.useState)(new Date);return(0,n.useEffect)(()=>{let e=setInterval(()=>{t(new Date)},1e3);return()=>clearInterval(e)},[]),(0,a.jsx)(D,{children:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}:${String(e.getSeconds()).padStart(2,"0")}`})};var M=((r={})[r.THEME_ADMIN_PANEL=0]="THEME_ADMIN_PANEL",r[r.SITE_ADMIN_PANEL=1]="SITE_ADMIN_PANEL",r[r.LINKS_ADMIN_PANEL=2]="LINKS_ADMIN_PANEL",r),K=i(9358),Y=i(7775),F=i(5906),G=i(8976),z=i(9006),R=i(8400),B=i(5685),q=i(8284),H=i(557),J=i(6786),V=i(4766),U=i(2566);let Q=()=>{let[e,t]=(0,n.useState)([]),[i,r]=(0,n.useState)(!1),[o,s]=(0,n.useState)(!1),[d]=K.Z.useForm(),[l]=K.Z.useForm(),[c,m]=(0,n.useState)(),[g,h]=(0,n.useState)(null),[u,p]=(0,n.useState)(null);(0,n.useEffect)(()=>{t(j.getAllCategories())},[]);let f=e=>{console.log("Editing category: ",e),m(e),d.setFieldsValue(e),r(!0)},x=i=>{t(e.filter(e=>e.id!==i)),j.deleteCategory(i),Y.ZP.success("Category deleted successfully!")},b=()=>{s(!0),l.resetFields(),h(null)},S=[{title:"ID",dataIndex:"id",key:"id",sorter:(e,t)=>e.id-t.id},{title:"Name",dataIndex:"name",key:"name"},{title:"Links",dataIndex:"links",key:"links",render:e=>(0,a.jsx)(F.Z,{size:"middle",children:e.map(e=>`${e.icon}: ${e.name?`${e.name}-> `:""}${e.url}`).join(", ")})},{title:"Action",key:"action",render:(e,t)=>(0,a.jsxs)(F.Z,{size:"middle",children:[(0,a.jsx)(G.ZP,{type:"primary",icon:(0,a.jsx)(H.Z,{}),onClick:()=>f(t),children:"Edit Category"}),(0,a.jsx)(G.ZP,{type:"dashed",icon:(0,a.jsx)(J.Z,{}),onClick:()=>x(t.id),children:"Delete Category"})]})}];return(0,a.jsxs)("div",{style:{padding:24},children:[(0,a.jsx)("h1",{children:"Data Management Panel"}),(0,a.jsx)(G.ZP,{type:"primary",icon:(0,a.jsx)(V.Z,{}),onClick:()=>{d.resetFields(),m(void 0),r(!0)},style:{marginBottom:16},children:"Add New Category"}),(0,a.jsx)(G.ZP,{type:"primary",icon:(0,a.jsx)(U.Z,{}),onClick:()=>b(),children:"Add Links"}),(0,a.jsx)(G.ZP,{type:"dashed",icon:(0,a.jsx)(V.Z,{}),onClick:()=>{j.clearStorage(),t([]),Y.ZP.success("All categories deleted successfully")},style:{marginBottom:16},children:"清空数据"}),(0,a.jsx)(z.Z,{dataSource:e,columns:S,rowKey:"id",pagination:{pageSize:5}}),(0,a.jsx)(R.Z,{title:`${c?"Edit":"Add"} Category`,open:i,onOk:()=>{d.validateFields().then(i=>{console.log(i),c?(t(e.map(e=>e.id===c.id?{...e,...i}:e)),j.updateCategory(i.id,i.name),Y.ZP.success("Category updated successfully!")):(t([...e,{id:Date.now(),...i,links:[]}]),j.addCategory(i.name),Y.ZP.success("Category added successfully!")),r(!1)})},onCancel:()=>{r(!1)},children:(0,a.jsxs)(K.Z,{form:d,layout:"vertical",children:[(0,a.jsx)(K.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(B.Z,{disabled:!!c})}),(0,a.jsx)(K.Z.Item,{name:"name",label:"Name",rules:[{required:!0,message:"Please input Name!"}],children:(0,a.jsx)(B.Z,{})})]})}),(0,a.jsx)(R.Z,{title:`${g??"Add"} Link`,open:o,onOk:()=>{l.validateFields().then(i=>{let r=e.findIndex(e=>e.id===u),a=[...e];if(g){console.log("updating link");let e=i.id,t={icon:i.icon,name:i.name,url:i.url};j.updateLink(r,e,t),Y.ZP.success("Link updated successfully!")}else console.log("adding link"),j.addLink(i.id,i.name,i.url,i.icon),Y.ZP.success("Link added successfully!");t(a),s(!1)})},onCancel:()=>{s(!1)},children:(0,a.jsxs)(K.Z,{form:l,layout:"vertical",children:[(0,a.jsx)(K.Z.Item,{name:"id",label:"分类",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(q.Z,{disabled:!!g,options:e.map(e=>({value:e.id,label:e.name}))})}),(0,a.jsx)(K.Z.Item,{name:"name",label:"链接名",rules:[{required:!1,message:"Please input Name!"}],children:(0,a.jsx)(B.Z,{})}),(0,a.jsx)(K.Z.Item,{name:"url",label:"链接",rules:[{required:!0,message:"Please input URL!"}],children:(0,a.jsx)(B.Z,{})}),(0,a.jsx)(K.Z.Item,{name:"icon",label:"图标",rules:[{required:!0,message:"Please input Icon!"}],children:(0,a.jsx)(B.Z,{})})]})})]})},W=e=>{switch(e.config){case M.THEME_ADMIN_PANEL:return(0,a.jsx)("div",{children:"主题管理面板(未完成)"});case M.SITE_ADMIN_PANEL:return(0,a.jsx)("div",{children:"网站管理面板(未完成)"});case M.LINKS_ADMIN_PANEL:return(0,a.jsx)(Q,{});default:return(0,a.jsx)("div",{children:"未知面板"})}},X=[{name:"链接配置面板",type:"link",value:M.LINKS_ADMIN_PANEL},{name:"主题配置面板",type:"link",value:M.THEME_ADMIN_PANEL},{name:"网站配置面板",type:"link",value:M.SITE_ADMIN_PANEL}],ee=e=>{let{visibleAdmin:t,setIsShowAdmin:i,setVisibleAdmin:r,setToConfig:n,isShowAdmin:o}=e,s=e=>()=>{switch(console.log("toAdmin",e),e.value){case M.LINKS_ADMIN_PANEL:n(M.LINKS_ADMIN_PANEL);break;case M.THEME_ADMIN_PANEL:n(M.THEME_ADMIN_PANEL);break;case M.SITE_ADMIN_PANEL:n(M.SITE_ADMIN_PANEL);break;default:r(!0)}r(!0),i(!1)};return(0,a.jsx)(a.Fragment,{children:(0,a.jsx)(R.Z,{title:"请选择进入哪一个面板",footer:[(0,a.jsx)(G.ZP,{style:{display:t?"":"none"},onClick:()=>{i(!1),r(!1)},children:"退出面板"},"back")],open:o,onCancel:()=>i(!1),children:X.map((e,t)=>(0,a.jsx)(G.ZP,{onClick:s(e),type:e.type,children:e.name},t))})})},et=d.Z.button`
  opacity: 0.5; /* 默认透明度 */
...
`,eo=e=>{let{cb:t}=e,i=w.getConfig(),r=j.getAllCategories(),n=j.getAllSearchEngines(),o=T.getConfig();return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ei,{children:(0,a.jsx)(er,{children:o.title})}),(0,a.jsxs)(ea,{children:[(0,a.jsx)(u,{searchEngines:n}),(0,a.jsx)(E,{categories:r})]}),(0,a.jsx)(P,{themeConfig:i,onSelect:t}),(0,a.jsx)(en,{children:`${o.copyright.text}`})]})},es="turnip-theme-active",ed=e=>{let[t,i]=(0,n.useState)(()=>{try{let t=localStorage.getItem(es);return t?JSON.parse(t):e.default}catch(t){return console.warn("Failed to parse saved theme:",t),e.default}});return(0,n.useEffect)(()=>{try{localStorage.setItem(es,JSON.stringify(t))}catch(e){console.warn("Failed to save theme:",e)}},[t]),[t,i]};var el=i(3727),ec=i(8142);i(8362);let em=document.getElementById("root");em&&o.createRoot(em).render((0,a.jsx)(n.StrictMode,{children:(0,a.jsx)(()=>{let[e,t]=(0,n.useState)(!1),[i,r]=(0,n.useState)(M.LINKS_ADMIN_PANEL),[o,d]=(0,n.useState)(!1),[l,c]=ed(w.getConfig());return(0,a.jsx)(s.a,{theme:l,children:(0,a.jsx)(v,{theme:l,children:(0,a.jsxs)(el.ZP,{theme:{algorithm:ec.Z.darkAlgorithm},children:[(0,a.jsx)(L,{}),(0,a.jsx)(et,{onClick:()=>d(!0),children:"管理面板"}),e?(0,a.jsx)(W,{config:i}):(0,a.jsx)(eo,{cb:c}),(0,a.jsx)(ee,{setVisibleAdmin:t,visibleAdmin:e,setToConfig:r,setIsShowAdmin:d,isShowAdmin:o})]})})})},{})}))}},t={};function i(r){var a=t[r];if(void 0!==a)return a.exports;var n=t[r]={exports:{}};return e[r](n,n.exports,i),n.exports}i.m=e,i.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return i.d(t,{a:t}),t},(()=>{var e,t=Object.getPrototypeOf?e=>Object.getPrototypeOf(e):e=>e.__proto__;i.t=function(r,a){if(1&a&&(r=this(r)),8&a||"object"==typeof r&&r&&(4&a&&r.__esModule||16&a&&"function"==typeof r.then))return r;var n=Object.create(null);i.r(n);var o={};e=e||[null,t({}),t([]),t(t)];for(var s=2&a&&r;"object"==typeof s&&!~e.indexOf(s);s=t(s))Object.getOwnPropertyNames(s).forEach(e=>{o[e]=()=>r[e]});return o.default=()=>r,i.d(n,o),n}})(),i.d=(e,t)=>{for(var r in t)i.o(t,r)&&!i.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},i.g=(()=>{if("object"==typeof globalThis)return globalThis;try{return this||Function("return this")()}catch(e){if("object"==typeof window)return window}})(),i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},(()=>{var e=[];i.O=(t,r,a,n)=>{if(r){n=n||0;for(var o=e.length;o>0&&e[o-1][2]>n;o--)e[o]=e[o-1];e[o]=[r,a,n];return}for(var s=1/0,o=0;o<e.length;o++){for(var[r,a,n]=e[o],d=!0,l=0;l<r.length;l++)(!1&n||s>=n)&&Object.keys(i.O).every(e=>i.O[e](r[l]))?r.splice(l--,1):(d=!1,n<s&&(s=n));if(d){e.splice(o--,1);var c=a();void 0!==c&&(t=c)}}return t}})(),i.rv=()=>"1.3.1",(()=>{var e={980:0};i.O.j=t=>0===e[t];var t=(t,r)=>{var a,n,[o,s,d]=r,l=0;if(o.some(t=>0!==e[t])){for(a in s)i.o(s,a)&&(i.m[a]=s[a]);if(d)var c=d(i)}for(t&&t(r);l<o.length;l++)n=o[l],i.o(e,n)&&e[n]&&e[n][0](),e[n]=0;return i.O(c)},r=self.webpackChunkrs_react_app=self.webpackChunkrs_react_app||[];r.forEach(t.bind(null,0)),r.push=t.bind(null,r.push.bind(r))})(),i.ruid="bundler=rspack@1.3.1";var r=i.O(void 0,["361","170"],function(){return i(4745)});r=i.O(r)})();