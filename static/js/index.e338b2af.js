(()=>{"use strict";var e={9339:function(e,t,i){var r,a=i(6773),n=i(1699),o=i(8511),s=i(6979),d=i(7498);let l=d.Z.div`
  margin: 2rem auto;
  max-width: 600px;
  width: 100%;
  padding: 0 15px;
...
`,L=()=>{let[e,t]=(0,n.useState)(new Date);return(0,n.useEffect)(()=>{let e=setInterval(()=>{t(new Date)},1e3);return()=>clearInterval(e)},[]),(0,a.jsx)(D,{children:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}:${String(e.getSeconds()).padStart(2,"0")}`})};var M=((r={})[r.THEME_ADMIN_PANEL=0]="THEME_ADMIN_PANEL",r[r.SITE_ADMIN_PANEL=1]="SITE_ADMIN_PANEL",r[r.LINKS_ADMIN_PANEL=2]="LINKS_ADMIN_PANEL",r),K=i(5230),Y=i(8927),F=i(736),G=i(1026),z=i(9340),R=i(2888),B=i(343),q=i(8072),H=i(1582),J=i(4573),U=i(7275),V=i(8589);let Q=()=>{let[e,t]=(0,n.useState)([]),[i,r]=(0,n.useState)(!1),[o,s]=(0,n.useState)(!1),[d]=K.Z.useForm(),[l]=K.Z.useForm(),[c,m]=(0,n.useState)(),[g,h]=(0,n.useState)(null),[u,p]=(0,n.useState)(null);(0,n.useEffect)(()=>{t(j.getAllCategories())},[]);let f=e=>{console.log("Editing category: ",e),m(e),d.setFieldsValue(e),r(!0)},x=i=>{t(e.filter(e=>e.id!==i)),j.deleteCategory(i),Y.ZP.success("Category deleted successfully!")},b=()=>{s(!0),l.resetFields(),h(null)},S=[{title:"ID",dataIndex:"id",key:"id"},{title:"Name",dataIndex:"name",key:"name"},{title:"Links",dataIndex:"links",key:"links",render:e=>(0,a.jsx)(F.Z,{size:"middle",children:e.map(e=>`${e.icon}: ${e.name?`${e.name}-> `:""}${e.url}`).join(", ")})},{title:"Action",key:"action",render:(e,t)=>(0,a.jsxs)(F.Z,{size:"middle",children:[(0,a.jsx)(G.ZP,{type:"primary",icon:(0,a.jsx)(H.Z,{}),onClick:()=>f(t),children:"Edit Category"}),(0,a.jsx)(G.ZP,{type:"dashed",icon:(0,a.jsx)(J.Z,{}),onClick:()=>x(t.id),children:"Delete Category"})]})}];return(0,a.jsxs)("div",{style:{padding:24},children:[(0,a.jsx)("h1",{children:"Data Management Panel"}),(0,a.jsx)(G.ZP,{type:"primary",icon:(0,a.jsx)(U.Z,{}),onClick:()=>{d.resetFields(),m(void 0),r(!0)},style:{marginBottom:16},children:"Add New Category"}),(0,a.jsx)(G.ZP,{type:"primary",icon:(0,a.jsx)(V.Z,{}),onClick:()=>b(),children:"Add Links"}),(0,a.jsx)(G.ZP,{type:"dashed",icon:(0,a.jsx)(U.Z,{}),onClick:()=>{j.clearStorage(),t([]),Y.ZP.success("All categories deleted successfully")},style:{marginBottom:16},children:"清空数据"}),(0,a.jsx)(z.Z,{dataSource:e,columns:S,rowKey:"id",pagination:{pageSize:5}}),(0,a.jsx)(R.Z,{title:`${c?"Edit":"Add"} Category`,open:i,onOk:()=>{d.validateFields().then(i=>{console.log(i),c?(t(e.map(e=>e.id===c.id?{...e,...i}:e)),j.updateCategory(i.id,i.name),Y.ZP.success("Category updated successfully!")):(t([...e,{id:Date.now(),...i,links:[]}]),j.addCategory(i.name),Y.ZP.success("Category added successfully!")),r(!1)})},onCancel:()=>{r(!1)},children:(0,a.jsxs)(K.Z,{form:d,layout:"vertical",children:[(0,a.jsx)(K.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(B.Z,{disabled:!!c})}),(0,a.jsx)(K.Z.Item,{name:"name",label:"Name",rules:[{required:!0,message:"Please input Name!"}],children:(0,a.jsx)(B.Z,{})})]})}),(0,a.jsx)(R.Z,{title:`${g??"Add"} Link`,open:o,onOk:()=>{l.validateFields().then(i=>{let r=e.findIndex(e=>e.id===u),a=[...e];if(g){console.log("updating link");let e=i.id,t={icon:i.icon,name:i.name,url:i.url};j.updateLink(r,e,t),Y.ZP.success("Link updated successfully!")}else console.log("adding link"),j.addLink(i.id,i.name,i.url,i.icon),Y.ZP.success("Link added successfully!");t(a),s(!1)})},onCancel:()=>{s(!1)},children:(0,a.jsxs)(K.Z,{form:l,layout:"vertical",children:[(0,a.jsx)(K.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(q.Z,{disabled:!!g,options:e.map(e=>({value:e.id,label:e.name}))})}),(0,a.jsx)(K.Z.Item,{name:"name",label:"Name",rules:[{required:!1,message:"Please input Name!"}],children:(0,a.jsx)(B.Z,{})}),(0,a.jsx)(K.Z.Item,{name:"url",label:"URL",rules:[{required:!0,message:"Please input URL!"}],children:(0,a.jsx)(B.Z,{})}),(0,a.jsx)(K.Z.Item,{name:"icon",label:"Icon",rules:[{required:!0,message:"Please input Icon!"}],children:(0,a.jsx)(B.Z,{})})]})})]})},W=e=>{switch(e.config){case M.THEME_ADMIN_PANEL:return(0,a.jsx)("div",{children:"主题管理面板(未完成)"});case M.SITE_ADMIN_PANEL:return(0,a.jsx)("div",{children:"网站管理面板(未完成)"});case M.LINKS_ADMIN_PANEL:return(0,a.jsx)(Q,{});default:return(0,a.jsx)("div",{children:"未知面板"})}},X=[{name:"链接配置面板",type:"link",value:M.LINKS_ADMIN_PANEL},{name:"主题配置面板",type:"link",value:M.THEME_ADMIN_PANEL},{name:"网站配置面板",type:"link",value:M.SITE_ADMIN_PANEL}],ee=e=>{let{visibleAdmin:t,setIsShowAdmin:i,setVisibleAdmin:r,setToConfig:n,isShowAdmin:o}=e,s=e=>()=>{switch(console.log("toAdmin",e),e.value){case M.LINKS_ADMIN_PANEL:n(M.LINKS_ADMIN_PANEL);break;case M.THEME_ADMIN_PANEL:n(M.THEME_ADMIN_PANEL);break;case M.SITE_ADMIN_PANEL:n(M.SITE_ADMIN_PANEL);break;default:r(!0)}r(!0),i(!1)};return(0,a.jsx)(a.Fragment,{children:(0,a.jsx)(R.Z,{title:"请选择进入哪一个面板",footer:[(0,a.jsx)(G.ZP,{style:{display:t?"":"none"},onClick:()=>{i(!1),r(!1)},children:"退出面板"},"back")],open:o,onCancel:()=>i(!1),children:X.map((e,t)=>(0,a.jsx)(G.ZP,{onClick:s(e),type:e.type,children:e.name},t))})})},et=d.Z.button`
  opacity: 0.5; /* 默认透明度 */
