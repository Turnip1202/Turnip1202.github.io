...
`;var ri=r(6656);let{Search:rs}=ei.A,ra=e=>{var t;let{searchEngines:r}=e,{isDark:a}=Q(),[n,o]=(0,s.useState)(""),[l,c]=(0,s.useState)((null==(t=r[0])?void 0:t.id)||"google"),d=(0,s.useCallback)(()=>{if(!n.trim())return;let e=r.find(e=>e.id===l);e&&window.open(e.url+encodeURIComponent(n.trim()),"_blank")},[n,l,r]),h=(0,s.useCallback)(e=>{"Enter"===e.key&&d()},[d]),g=r.map(e=>({value:e.id,label:(0,i.jsxs)("span",{children:[e.icon," ",e.name]})})),x={display:"flex",gap:"12px",width:"100%",alignItems:"center",background:a?m.background:p.background,borderRadius:b,padding:"8px 12px",boxShadow:v,backdropFilter:"blur(10px)",WebkitBackdropFilter:"blur(10px)"};return(0,i.jsxs)("div",{style:{margin:"2rem auto 3rem",maxWidth:"700px",width:"100%",animation:"searchFadeIn 0.8s ease-out 0.3s both"},children:[(0,i.jsx)("style",{children:`
        ...
        `}),(0,i.jsx)(ed.A,{size:"small",style:x,className:"clock-card",styles:{body:{padding:"0.75rem 1rem"}},hoverable:!0,children:(0,i.jsxs)(er.A,{orientation:"vertical",align:"center",size:2,children:[(0,i.jsxs)(er.A,{size:4,children:[(0,i.jsx)(td.A,{style:{color:l?"#ffffff":"#2c3e50",opacity:.8}}),(0,i.jsx)(ry,{style:{color:l?"#ffffff":"#2c3e50",opacity:.8,fontSize:"0.85em"},children:h})]}),(0,i.jsx)(ry,{strong:!0,style:{color:l?"#ffffff":"#2c3e50",fontSize:"1em",fontWeight:600,fontFamily:'"SF Mono", Monaco, "Cascadia Code", "Roboto Mono", Consolas, "Courier New", monospace'},children:g})]})})]})},rb=o.A.button`
  opacity: 0.5; /* 默认透明度 */
