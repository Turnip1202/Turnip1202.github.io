(()=>{"use strict";var e={3663:function(e,t,i){var r,a=i(6773),n=i(1699),o=i(8511),s=i(6979),d=i(7498);let l=d.Z.div`
  margin: 2rem auto;
  max-width: 600px;
  width: 100%;
  padding: 0 15px;
...
`,D=(0,d.Z)(P)`
  ...
  align-items: center;
  justify-content: center;
`,K=e=>{let{themeConfig:t,onSelect:i}=e;t=I.getConfig();let[r,o]=(0,n.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-mode");return!!e&&"dark"===e}catch(e){return console.warn("Failed to load theme mode:",e),!1}}),[s,d]=(0,n.useState)(()=>{try{return localStorage.getItem("turnip-theme-preset")||"morning"}catch(e){return console.warn("Failed to load theme preset:",e),"morning"}}),[l,c]=(0,n.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-auto");return!!e&&"true"===e}catch(e){return console.warn("Failed to load auto mode:",e),!1}});(0,n.useEffect)(()=>{try{localStorage.setItem("turnip-theme-mode",r?"dark":"light"),localStorage.setItem("turnip-theme-auto",String(l)),localStorage.setItem("turnip-theme-preset",s)}catch(e){console.warn("Failed to save theme settings:",e)}},[r,l,s]),(0,n.useEffect)(()=>{let e=()=>{if(!l)return;let e=new Date().getHours(),t=e>=18||e<6;t!==r&&o(t)};e();let t=setInterval(e,6e4);return()=>clearInterval(t)},[l,r]);let g=(0,n.useCallback)(()=>{let e=t.presets.find(e=>e.id===s)||t.presets[0];i({id:"custom",name:r?"暗黑主题":"明亮主题",backgroundImage:r?"linear-gradient(120deg, #2d3436 0%, #2d3436 100%)":e.backgroundImage,blur:e.blur,opacity:r?.85:e.opacity})},[r,s,i]);return(0,n.useEffect)(()=>{g()},[r,g]),(0,a.jsxs)(Z,{children:[!r&&(0,a.jsx)($,{children:t.presets.map(e=>(0,a.jsx)(O,{isSelected:s===e.id,onClick:()=>d(e.id),title:e.name,style:{background:e.backgroundImage}},e.id))}),(0,a.jsxs)(A,{children:[(0,a.jsx)(P,{active:r,onClick:()=>{c(!1),o(!r)},title:r?"切换到明亮模式":"切换到暗黑模式",children:r?(0,a.jsx)("span",{children:"\uD83C\uDF19"}):(0,a.jsx)("span",{children:"☀️"})}),(0,a.jsx)(D,{active:l,onClick:()=>c(!l),title:l?"关闭自动切换":"开启自动切换",children:"\uD83D\uDD52"})]})]})},Y=d.Z.div`
  position: absolute;
  top: 0.1rem;
  right: 1rem;
  font-size: 1.2rem;
...
`,G=()=>{let[e,t]=(0,n.useState)(new Date);return(0,n.useEffect)(()=>{let e=setInterval(()=>{t(new Date)},1e3);return()=>clearInterval(e)},[]),(0,a.jsx)(Y,{children:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}:${String(e.getSeconds()).padStart(2,"0")}`})};var M=i(5230),F=i(8927),L=i(736),z=i(1026),R=i(6967),B=i(2888),q=i(343),J=i(8589),H=i(1582),U=i(4573),V=i(7275);let Q=()=>{let[e,t]=(0,n.useState)([]),[i,r]=(0,n.useState)(!1),[o,s]=(0,n.useState)(!1),[d]=M.Z.useForm(),[l]=M.Z.useForm(),[c,g]=(0,n.useState)(),[m,h]=(0,n.useState)(null),[u,p]=(0,n.useState)(null);(0,n.useEffect)(()=>{t(j.getAllCategories())},[]);let f=e=>{console.log("Editing category: ",e),g(e),d.setFieldsValue(e),r(!0)},x=i=>{t(e.filter(e=>e.id!==i)),j.deleteCategory(i),F.ZP.success("Category deleted successfully!")},b=e=>{p(e.id),s(!0),l.resetFields(),h(null)},S=[{title:"ID",dataIndex:"id",key:"id"},{title:"Name",dataIndex:"name",key:"name"},{title:"Links",dataIndex:"links",key:"links",render:e=>(0,a.jsx)(L.Z,{size:"middle",children:e.map(e=>`${e.icon}: ${e.name?`${e.name}-> `:""}${e.url}`).join(", ")})},{title:"Action",key:"action",render:(e,t)=>(0,a.jsxs)(L.Z,{size:"middle",children:[(0,a.jsx)(z.ZP,{type:"primary",icon:(0,a.jsx)(J.Z,{}),onClick:()=>b(t),children:"Manage Links"}),(0,a.jsx)(z.ZP,{type:"primary",icon:(0,a.jsx)(H.Z,{}),onClick:()=>f(t),children:"Edit Category"}),(0,a.jsx)(z.ZP,{type:"dashed",icon:(0,a.jsx)(U.Z,{}),onClick:()=>x(t.id),children:"Delete Category"})]})}];return(0,a.jsxs)("div",{style:{padding:24},children:[(0,a.jsx)("h1",{children:"Data Management Panel"}),(0,a.jsx)(z.ZP,{type:"primary",icon:(0,a.jsx)(V.Z,{}),onClick:()=>{d.resetFields(),g(null),r(!0)},style:{marginBottom:16},children:"Add New Category"}),(0,a.jsx)(z.ZP,{type:"dashed",icon:(0,a.jsx)(V.Z,{}),onClick:()=>{j.clearStorage(),t([]),F.ZP.success("All categories deleted successfully")},style:{marginBottom:16},children:"清空数据"}),(0,a.jsx)(R.Z,{dataSource:e,columns:S,rowKey:"id",pagination:{pageSize:5}}),(0,a.jsx)(B.Z,{title:`${c?"Edit":"Add"} Category`,open:i,onOk:()=>{d.validateFields().then(i=>{console.log(i),c?(t(e.map(e=>e.id===c.id?{...e,...i}:e)),j.updateCategory(i.id,i.name),F.ZP.success("Category updated successfully!")):(t([...e,{id:Date.now(),...i,links:[]}]),j.addCategory(i.name),F.ZP.success("Category added successfully!")),r(!1)})},onCancel:()=>{r(!1)},children:(0,a.jsxs)(M.Z,{form:d,layout:"vertical",children:[(0,a.jsx)(M.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(q.Z,{disabled:!!c})}),(0,a.jsx)(M.Z.Item,{name:"name",label:"Name",rules:[{required:!0,message:"Please input Name!"}],children:(0,a.jsx)(q.Z,{})})]})}),(0,a.jsx)(B.Z,{title:`${m?"Edit":"Add"} Link`,open:o,onOk:()=>{l.validateFields().then(i=>{let r=e.findIndex(e=>e.id===u),a=[...e];m?(a[r].links=a[r].links.map(e=>e.id===m.id?{...e,...i}:e),F.ZP.success("Link updated successfully!")):(a[r].links.push({id:Date.now(),...i}),F.ZP.success("Link added successfully!")),t(a),localStorage.setItem("yourDataKey",JSON.stringify(a)),s(!1)})},onCancel:()=>{s(!1)},children:(0,a.jsxs)(M.Z,{form:l,layout:"vertical",children:[(0,a.jsx)(M.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(q.Z,{disabled:!!m})}),(0,a.jsx)(M.Z.Item,{name:"name",label:"Name",rules:[{required:!1,message:"Please input Name!"}],children:(0,a.jsx)(q.Z,{})}),(0,a.jsx)(M.Z.Item,{name:"url",label:"URL",rules:[{required:!0,message:"Please input URL!"}],children:(0,a.jsx)(q.Z,{})}),(0,a.jsx)(M.Z.Item,{name:"icon",label:"Icon",rules:[{required:!0,message:"Please input Icon!"}],children:(0,a.jsx)(q.Z,{})})]})})]})},W=e=>{switch(e.config){case C.THEME_ADMIN_PANEL:return(0,a.jsx)("div",{children:"主题管理面板"});case C.SITE_ADMIN_PANEL:return(0,a.jsx)("div",{children:"网站管理面板"});case C.LINKS_ADMIN_PANEL:return(0,a.jsx)(Q,{});default:return(0,a.jsx)("div",{children:"未知面板"})}},X=d.Z.button`
  opacity: 0.5; /* 默认透明度 */
...
`,ea=e=>{let{cb:t}=e,i=I.getConfig(),r=j.getAllCategories(),n=j.getAllSearchEngines(),o=T.getConfig();return(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(ee,{children:(0,a.jsx)(et,{children:o.title})}),(0,a.jsxs)(ei,{children:[(0,a.jsx)(u,{searchEngines:n}),(0,a.jsx)(E,{categories:r})]}),(0,a.jsx)(K,{themeConfig:i,onSelect:t}),(0,a.jsx)(er,{children:`${o.copyright.text}`})]})},en="turnip-theme-active",eo=e=>{let[t,i]=(0,n.useState)(()=>{try{let t=localStorage.getItem(en);return t?JSON.parse(t):e.default}catch(t){return console.warn("Failed to parse saved theme:",t),e.default}});return(0,n.useEffect)(()=>{try{localStorage.setItem(en,JSON.stringify(t))}catch(e){console.warn("Failed to save theme:",e)}},[t]),[t,i]};var es=i(4559),ed=i(9546);let el=`请输入要进入的面板:
主题配置请输入：1
网站配置请输入：2
链接配置请输入：3
`;i(7360);let ec=document.getElementById("root");ec&&o.createRoot(ec).render((0,a.jsx)(n.StrictMode,{children:(0,a.jsx)(()=>{let[e,t]=(0,n.useState)(!1),[i,r]=(0,n.useState)(C.LINKS_ADMIN_PANEL),o=N(e,el,r,t),[d,l]=eo(I.getConfig());return(0,a.jsx)(s.a,{theme:d,children:(0,a.jsx)(v,{theme:d,children:(0,a.jsxs)(es.ZP,{theme:{algorithm:ed.Z.darkAlgorithm},children:[(0,a.jsx)(G,{}),(0,a.jsx)(X,{onClick:o,children:"管理面板"}),e?(0,a.jsx)(W,{config:i}):(0,a.jsx)(ea,{cb:l})]})})})},{})}))}},t={};function i(r){var a=t[r];if(void 0!==a)return a.exports;var n=t[r]={exports:{}};return e[r](n,n.exports,i),n.exports}i.m=e,i.n=e=>{var t=e&&e.__esModule?()=>e.default:()=>e;return i.d(t,{a:t}),t},(()=>{var e,t=Object.getPrototypeOf?e=>Object.getPrototypeOf(e):e=>e.__proto__;i.t=function(r,a){if(1&a&&(r=this(r)),8&a||"object"==typeof r&&r&&(4&a&&r.__esModule||16&a&&"function"==typeof r.then))return r;var n=Object.create(null);i.r(n);var o={};e=e||[null,t({}),t([]),t(t)];for(var s=2&a&&r;"object"==typeof s&&!~e.indexOf(s);s=t(s))Object.getOwnPropertyNames(s).forEach(e=>{o[e]=()=>r[e]});return o.default=()=>r,i.d(n,o),n}})(),i.d=(e,t)=>{for(var r in t)i.o(t,r)&&!i.o(e,r)&&Object.defineProperty(e,r,{enumerable:!0,get:t[r]})},(()=>{i.g=(()=>{if("object"==typeof globalThis)return globalThis;try{return this||Function("return this")()}catch(e){if("object"==typeof window)return window}})()})(),i.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),i.r=e=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},(()=>{var e=[];i.O=(t,r,a,n)=>{if(r){n=n||0;for(var o=e.length;o>0&&e[o-1][2]>n;o--)e[o]=e[o-1];e[o]=[r,a,n];return}for(var s=1/0,o=0;o<e.length;o++){for(var[r,a,n]=e[o],d=!0,l=0;l<r.length;l++)(!1&n||s>=n)&&Object.keys(i.O).every(e=>i.O[e](r[l]))?r.splice(l--,1):(d=!1,n<s&&(s=n));if(d){e.splice(o--,1);var c=a();void 0!==c&&(t=c)}}return t}})(),i.rv=()=>"1.2.8",(()=>{var e={980:0};i.O.j=t=>0===e[t];var t=(t,r)=>{var a,n,[o,s,d]=r,l=0;if(o.some(t=>0!==e[t])){for(a in s)i.o(s,a)&&(i.m[a]=s[a]);if(d)var c=d(i)}for(t&&t(r);l<o.length;l++)n=o[l],i.o(e,n)&&e[n]&&e[n][0](),e[n]=0;return i.O(c)},r=self.webpackChunkrs_react_app=self.webpackChunkrs_react_app||[];r.forEach(t.bind(null,0)),r.push=t.bind(null,r.push.bind(r))})(),i.ruid="bundler=rspack@1.2.8";var r=i.O(void 0,["361","864"],function(){return i(3663)});r=i.O(r)})();