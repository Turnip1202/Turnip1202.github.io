(()=>{"use strict";var e={928:function(e,t,r){var i,o=r(773),a=r(699),n=r(511),s=r(598),d=r(333);let c=d.Z.div`
  margin: 2rem auto;
  max-width: 600px;
  width: 100%;
  padding: 0 15px;
...
`,p=e=>{let{searchEngines:t}=e,[r,i]=(0,a.useState)(""),[n,s]=(0,a.useState)(t[0].id);return(0,o.jsx)(c,{children:(0,o.jsxs)(l,{onSubmit:e=>{if(e.preventDefault(),!r.trim())return;let i=t.find(e=>e.id===n);i&&window.open(i.url+encodeURIComponent(r),"_blank")},children:[(0,o.jsx)(g,{type:"text",value:r,onChange:e=>i(e.target.value),placeholder:"输入搜索内容..."}),(0,o.jsx)(h,{value:n,onChange:e=>s(e.target.value),children:t.map(e=>(0,o.jsxs)("option",{value:e.id,children:[e.icon," ",e.name]},e.id))}),(0,o.jsx)(m,{type:"submit",children:"搜索"})]})})},u=d.Z.section`
  margin: 2rem 0;
  padding: 1rem;
...
`,v=e=>{let{categories:t}=e;return(0,o.jsx)(o.Fragment,{children:t.map(e=>(0,o.jsxs)(u,{children:[(0,o.jsx)(f,{children:e.name}),(0,o.jsx)(x,{children:e.links.map(e=>(0,o.jsxs)(b,{href:e.url,target:"_blank",rel:"noopener noreferrer",children:[(0,o.jsx)(S,{children:e.icon}),(0,o.jsx)(E,{children:e.name})]},e.id))})]},e.id))})},w=d.Z.div`
  min-height: 100vh;
  position: relative;
  padding: 2rem;
...
`,K=(0,d.Z)(C)`
  ...
  align-items: center;
  justify-content: center;
`,D=e=>{let{themeConfig:t,onSelect:r}=e;t=k.getConfig();let[i,n]=(0,a.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-mode");return!!e&&"dark"===e}catch(e){return console.warn("Failed to load theme mode:",e),!1}}),[s,d]=(0,a.useState)(()=>{try{return localStorage.getItem("turnip-theme-preset")||"morning"}catch(e){return console.warn("Failed to load theme preset:",e),"morning"}}),[c,l]=(0,a.useState)(()=>{try{let e=localStorage.getItem("turnip-theme-auto");return!!e&&"true"===e}catch(e){return console.warn("Failed to load auto mode:",e),!1}});(0,a.useEffect)(()=>{try{localStorage.setItem("turnip-theme-mode",i?"dark":"light"),localStorage.setItem("turnip-theme-auto",String(c)),localStorage.setItem("turnip-theme-preset",s)}catch(e){console.warn("Failed to save theme settings:",e)}},[i,c,s]),(0,a.useEffect)(()=>{let e=()=>{if(!c)return;let e=new Date().getHours(),t=e>=18||e<6;t!==i&&n(t)};e();let t=setInterval(e,6e4);return()=>clearInterval(t)},[c,i]);let g=(0,a.useCallback)(()=>{let e=t.presets.find(e=>e.id===s)||t.presets[0];r({id:"custom",name:i?"暗黑主题":"明亮主题",backgroundImage:i?"linear-gradient(120deg, #2d3436 0%, #2d3436 100%)":e.backgroundImage,blur:e.blur,opacity:i?.85:e.opacity})},[i,s,r]);return(0,a.useEffect)(()=>{g()},[i,g]),(0,o.jsxs)(N,{children:[!i&&(0,o.jsx)($,{children:t.presets.map(e=>(0,o.jsx)(A,{isSelected:s===e.id,onClick:()=>d(e.id),title:e.name,style:{background:e.backgroundImage}},e.id))}),(0,o.jsxs)(O,{children:[(0,o.jsx)(C,{active:i,onClick:()=>{l(!1),n(!i)},title:i?"切换到明亮模式":"切换到暗黑模式",children:i?(0,o.jsx)("span",{children:"\uD83C\uDF19"}):(0,o.jsx)("span",{children:"☀️"})}),(0,o.jsx)(K,{active:c,onClick:()=>l(!c),title:c?"关闭自动切换":"开启自动切换",children:"\uD83D\uDD52"})]})]})},Y=d.Z.div`
  position: absolute;
  top: 0.1rem;
  right: 1rem;
  font-size: 1.2rem;
...
`,G=()=>{let[e,t]=(0,a.useState)(new Date);return(0,a.useEffect)(()=>{let e=setInterval(()=>{t(new Date)},1e3);return()=>clearInterval(e)},[]),(0,o.jsx)(Y,{children:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}:${String(e.getSeconds()).padStart(2,"0")}`})};var M=((i={})[i.THEME_ADMIN_PANEL=0]="THEME_ADMIN_PANEL",i[i.SITE_ADMIN_PANEL=1]="SITE_ADMIN_PANEL",i[i.LINKS_ADMIN_PANEL=2]="LINKS_ADMIN_PANEL",i);let Z=e=>{switch(e.config){case M.THEME_ADMIN_PANEL:return(0,o.jsx)("div",{children:"主题管理面板"});case M.SITE_ADMIN_PANEL:return(0,o.jsx)("div",{children:"网站管理面板"});case M.LINKS_ADMIN_PANEL:return(0,o.jsx)("div",{children:"链接管理面板"});default:return(0,o.jsx)("div",{children:"未知面板"})}};d.Z.div`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
  ...
  display: ${e=>e.isOpen?"block":"none"}; /* 根据 isOpen 控制显示隐藏 */
  justify-content: center;
  align-items: center;
`,d.Z.div`
  background: white;
...
`,B=e=>{let{cb:t}=e,r=k.getConfig(),i=_.getAllCategories(),a=_.getAllSearchEngines(),n=j.getConfig();return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(z,{children:(0,o.jsx)(L,{children:n.title})}),(0,o.jsxs)(R,{children:[(0,o.jsx)(p,{searchEngines:a}),(0,o.jsx)(v,{categories:i})]}),(0,o.jsx)(D,{themeConfig:r,onSelect:t}),(0,o.jsx)(F,{children:`${n.copyright.text}`})]})},H="turnip-theme-active",J=e=>{let[t,r]=(0,a.useState)(()=>{try{let t=localStorage.getItem(H);return t?JSON.parse(t):e.default}catch(t){return console.warn("Failed to parse saved theme:",t),e.default}});return(0,a.useEffect)(()=>{try{localStorage.setItem(H,JSON.stringify(t))}catch(e){console.warn("Failed to save theme:",e)}},[t]),[t,r]};r(454);let q=document.getElementById("root");q&&n.createRoot(q).render((0,o.jsx)(a.StrictMode,{children:(0,o.jsx)(()=>{let[e,t]=(0,a.useState)(!1),[r,i]=(0,a.useState)(M.LINKS_ADMIN_PANEL),[n,d]=J(k.getConfig());return(0,o.jsx)(s.a,{theme:n,children:(0,o.jsxs)(w,{theme:n,children:[(0,o.jsx)(G,{}),(0,o.jsx)(P,{onClick:()=>{let r=`请输入要进入的面板:
      主题配置请输入：1
      网站配置请输入：2
      链接配置请输入：3
      `;if(!e){let e=prompt(r);if(null===e||""===e)return;switch(console.log(e),e){case"1":i(M.THEME_ADMIN_PANEL);break;case"2":i(M.SITE_ADMIN_PANEL);break;case"3":i(M.LINKS_ADMIN_PANEL)}}t(!e)},children:"管理面板"}),e?(0,o.jsx)(Z,{config:r}):(0,o.jsx)(B,{cb:d})]})})},{})}))}},t={};function r(i){var o=t[i];if(void 0!==o)return o.exports;var a=t[i]={exports:{}};return e[i](a,a.exports,r),a.exports}r.m=e,(()=>{var e,t=Object.getPrototypeOf?e=>Object.getPrototypeOf(e):e=>e.__proto__;r.t=function(i,o){if(1&o&&(i=this(i)),8&o||"object"==typeof i&&i&&(4&o&&i.__esModule||16&o&&"function"==typeof i.then))return i;var a=Object.create(null);r.r(a);var n={};e=e||[null,t({}),t([]),t(t)];for(var s=2&o&&i;"object"==typeof s&&!~e.indexOf(s);s=t(s))Object.getOwnPropertyNames(s).forEach(e=>{n[e]=()=>i[e]});return n.default=()=>i,r.d(a,n),a}})(),r.d=(e,t)=>{for(var i in t)r.o(t,i)&&!r.o(e,i)&&Object.defineProperty(e,i,{enumerable:!0,get:t[i]})},r.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),r.r=function(e){"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},(()=>{var e=[];r.O=function(t,i,o,a){if(i){a=a||0;for(var n=e.length;n>0&&e[n-1][2]>a;n--)e[n]=e[n-1];e[n]=[i,o,a];return}for(var s=1/0,n=0;n<e.length;n++){for(var i=e[n][0],o=e[n][1],a=e[n][2],d=!0,c=0;c<i.length;c++)(!1&a||s>=a)&&Object.keys(r.O).every(function(e){return r.O[e](i[c])})?i.splice(c--,1):(d=!1,a<s&&(s=a));if(d){e.splice(n--,1);var l=o();void 0!==l&&(t=l)}}return t}})(),r.rv=()=>"1.2.7",(()=>{var e={980:0};r.O.j=t=>0===e[t];var t=(t,i)=>{var o,a,[n,s,d]=i,c=0;if(n.some(t=>0!==e[t])){for(o in s)r.o(s,o)&&(r.m[o]=s[o]);if(d)var l=d(r)}for(t&&t(i);c<n.length;c++)a=n[c],r.o(e,a)&&e[a]&&e[a][0](),e[a]=0;return r.O(l)},i=self.webpackChunkrs_react_app=self.webpackChunkrs_react_app||[];i.forEach(t.bind(null,0)),i.push=t.bind(null,i.push.bind(i))})(),r.ruid="bundler=rspack@1.2.7";var i=r.O(void 0,["361","298"],function(){return r(928)});i=r.O(i)})();