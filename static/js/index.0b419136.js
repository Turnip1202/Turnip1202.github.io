...
`,Y=()=>{let[e,t]=(0,n.useState)(new Date);return(0,n.useEffect)(()=>{let e=setInterval(()=>{t(new Date)},1e3);return()=>clearInterval(e)},[]),(0,a.jsx)(L,{children:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")} ${String(e.getHours()).padStart(2,"0")}:${String(e.getMinutes()).padStart(2,"0")}:${String(e.getSeconds()).padStart(2,"0")}`})};var G=i(5230),M=i(8927),F=i(736),z=i(1026),R=i(6967),B=i(2888),q=i(343),J=i(8589),H=i(1582),U=i(4573),V=i(7275);let Q=()=>{let[e,t]=(0,n.useState)([]),[i,r]=(0,n.useState)(!1),[o,s]=(0,n.useState)(!1),[d]=G.Z.useForm(),[l]=G.Z.useForm(),[c,g]=(0,n.useState)(),[m,h]=(0,n.useState)(null),[u,p]=(0,n.useState)(null);(0,n.useEffect)(()=>{t(j.getAllCategories())},[]);let f=e=>{console.log("Editing category: ",e),g(e),d.setFieldsValue(e),r(!0)},x=i=>{t(e.filter(e=>e.id!==i)),j.deleteCategory(i),M.ZP.success("Category deleted successfully!")},b=e=>{p(e.id),s(!0),l.resetFields(),h(null)},S=[{title:"ID",dataIndex:"id",key:"id"},{title:"Name",dataIndex:"name",key:"name"},{title:"Links",dataIndex:"links",key:"links",render:e=>(0,a.jsx)(F.Z,{size:"middle",children:e.map(e=>`${e.icon}: ${e.name?`${e.name}-> `:""}${e.url}`).join(", ")})},{title:"Action",key:"action",render:(e,t)=>(0,a.jsxs)(F.Z,{size:"middle",children:[(0,a.jsx)(z.ZP,{type:"primary",icon:(0,a.jsx)(J.Z,{}),onClick:()=>b(t),children:"Manage Links"}),(0,a.jsx)(z.ZP,{type:"primary",icon:(0,a.jsx)(H.Z,{}),onClick:()=>f(t),children:"Edit Category"}),(0,a.jsx)(z.ZP,{type:"dashed",icon:(0,a.jsx)(U.Z,{}),onClick:()=>x(t.id),children:"Delete Category"})]})}];return(0,a.jsxs)("div",{style:{padding:24},children:[(0,a.jsx)("h1",{children:"Data Management Panel"}),(0,a.jsx)(z.ZP,{type:"primary",icon:(0,a.jsx)(V.Z,{}),onClick:()=>{d.resetFields(),g(null),r(!0)},style:{marginBottom:16},children:"Add New Category"}),(0,a.jsx)(z.ZP,{type:"dashed",icon:(0,a.jsx)(V.Z,{}),onClick:()=>{j.clearStorage(),t([]),M.ZP.success("All categories deleted successfully")},style:{marginBottom:16},children:"清空数据"}),(0,a.jsx)(R.Z,{dataSource:e,columns:S,rowKey:"id",pagination:{pageSize:5}}),(0,a.jsx)(B.Z,{title:`${c?"Edit":"Add"} Category`,open:i,onOk:()=>{d.validateFields().then(i=>{console.log(i),c?(t(e.map(e=>e.id===c.id?{...e,...i}:e)),j.updateCategory(i.id,i.name),M.ZP.success("Category updated successfully!")):(t([...e,{id:Date.now(),...i,links:[]}]),j.addCategory(i.name),M.ZP.success("Category added successfully!")),r(!1)})},onCancel:()=>{r(!1)},children:(0,a.jsxs)(G.Z,{form:d,layout:"vertical",children:[(0,a.jsx)(G.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(q.Z,{disabled:!!c})}),(0,a.jsx)(G.Z.Item,{name:"name",label:"Name",rules:[{required:!0,message:"Please input Name!"}],children:(0,a.jsx)(q.Z,{})})]})}),(0,a.jsx)(B.Z,{title:`${m?"Edit":"Add"} Link`,open:o,onOk:()=>{l.validateFields().then(i=>{let r=e.findIndex(e=>e.id===u),a=[...e];if(m){console.log("updating link");let e=i.id,t={icon:i.icon,name:i.name,url:i.url};j.updateLink(r,e,t),M.ZP.success("Link updated successfully!")}else console.log("adding link"),j.addLink(r,i.name,i.url,i.icon),M.ZP.success("Link added successfully!");t(a),localStorage.setItem("yourDataKey",JSON.stringify(a)),s(!1)})},onCancel:()=>{s(!1)},children:(0,a.jsxs)(G.Z,{form:l,layout:"vertical",children:[(0,a.jsx)(G.Z.Item,{name:"id",label:"ID",rules:[{required:!0,message:"Please input ID!"}],children:(0,a.jsx)(q.Z,{disabled:!!m})}),(0,a.jsx)(G.Z.Item,{name:"name",label:"Name",rules:[{required:!1,message:"Please input Name!"}],children:(0,a.jsx)(q.Z,{})}),(0,a.jsx)(G.Z.Item,{name:"url",label:"URL",rules:[{required:!0,message:"Please input URL!"}],children:(0,a.jsx)(q.Z,{})}),(0,a.jsx)(G.Z.Item,{name:"icon",label:"Icon",rules:[{required:!0,message:"Please input Icon!"}],children:(0,a.jsx)(q.Z,{})})]})})]})},W=e=>{switch(e.config){case C.THEME_ADMIN_PANEL:return(0,a.jsx)("div",{children:"主题管理面板"});case C.SITE_ADMIN_PANEL:return(0,a.jsx)("div",{children:"网站管理面板"});case C.LINKS_ADMIN_PANEL:return(0,a.jsx)(Q,{});default:return(0,a.jsx)("div",{children:"未知面板"})}},X=d.Z.button`
  opacity: 0.5; /* 默认透明度 */
