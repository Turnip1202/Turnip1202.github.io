(()=>{"use strict";var e={165:function(e,r,t){var n=t(773),i=t(699),o=t(511),a=t(880);let d=[{id:0,name:"Turnip",links:[{id:1,name:"Turnip's Blog",url:"https://turnip1202.github.io/my-blog-astro/",icon:"\uD83E\uDD55"},{id:2,name:"GitHub",url:"https://github.com/Turnip1202",icon:"⭐"},{id:3,name:"稀土掘金",url:"https://juejin.cn/user/1684912023022440",icon:"\uD83D\uDD28"},{id:4,name:"哔哩哔哩",url:"https://b23.tv/zpySzz9",icon:"\uD83C\uDFAE"},{id:5,name:"抖音",url:"https://v.douyin.com/if78aSq9/",icon:"\uD83C\uDFAC"}]},{id:1,name:"开发工具",links:[{id:1,name:"GitHub",url:"https://github.com",icon:"\uD83D\uDC19"},{id:2,name:"VS Code",url:"https://code.visualstudio.com",icon:"\uD83D\uDCDD"},{id:3,name:"Stack Overflow",url:"https://stackoverflow.com",icon:"\uD83D\uDCA1"}]},{id:2,name:"学习资源",links:[{id:4,name:"TypeScript",url:"https://www.typescriptlang.org",icon:"\uD83D\uDCD8"},{id:5,name:"React Docs",url:"https://reactjs.org",icon:"⚛️"},{id:6,name:"掘金",url:"https://juejin.cn",icon:"\uD83C\uDFAF"}]}],p=[{id:"google",name:"Google",url:"https://www.google.com/search?q=",icon:"\uD83D\uDD0D"},{id:"bing",name:"Bing",url:"https://www.bing.com/search?q=",icon:"\uD83D\uDD0E"},{id:"baidu",name:"百度",url:"https://www.baidu.com/s?wd=",icon:"\uD83D\uDD0D"}],l=a.Z.div`
  margin: 2rem auto;
  max-width: 600px;
  width: 100%;
  padding: 0 15px;
...
`,Z=e=>{let{onSelect:r}=e;return(0,n.jsx)(O,{children:y.presets.map(e=>(0,n.jsx)(S,{bgImage:e.backgroundImage,onClick:()=>r(e),title:e.name},e.id))})},_="turnip-theme",z=()=>{let[e,r]=(0,i.useState)(()=>{let e=localStorage.getItem(_);return e?JSON.parse(e):y.default});return(0,i.useEffect)(()=>{localStorage.setItem(_,JSON.stringify(e))},[e]),[e,r]},I=a.Z.header`
  text-align: center;
  margin-bottom: 2rem;
  position: relative;
`,C=a.Z.h1`
