    ...
    links: [
      {
        id: 1,
        name: 'Turnip博客',
        url: 'https://turnip1202.github.io/my-blog-astro/',
        icon: '🥕',
      },
      {
        id: 2,
        name: 'GitHub',
        url: 'https://github.com/Turnip1202',
        icon: '⭐',
      }, // 替代：使用星星图标
      {
        id: 3,
      ...
      { id: 4, name: '哔哩哔哩', url: 'https://b23.tv/zpySzz9', icon: '🎮' }, // 替代：使用游戏图标
      {
        id: 5,
        name: '抖音',
        url: 'https://v.douyin.com/if78aSq9/',
        icon: '🎬',
      }, // 替代：使用电影图标
      {
        id: 6,
        name: 'react-study',
        url: 'https://turnip1202.github.io/react-study',
        icon: '📋',
      }, // 替代：使用电影图标
      {
        id: 7,
        name: 'ToDo-List',
        url: 'https://turnip1202.github.io/react18-todo',
        icon: '📝',
      }, // 替代：使用电影图标
    ],
  },
